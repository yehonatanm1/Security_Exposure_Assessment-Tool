# 🛡️ Security_Exposure_Assessment-Tool
...
**Security_Exposure_Assessment-Tool** is an educational Python project designed for research and training in cybersecurity and malware analysis. It demonstrates how data can be collected from a Windows machine using Python — including:
...
### Clone the project
```bash
git clone [https://github.com/yehonatanm1/Security_Exposure_Assessment-Tool.git](https://github.com/yehonatanm1/Security_Exposure_Assessment-Tool.git)
cd Security_Exposure_Assessment-Tool
pip install -r requirements.txt
python docs_tool/SEAT.py
